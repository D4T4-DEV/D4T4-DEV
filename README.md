# 👨‍💻 David Trejo — D4T4-D3V

**Full-Stack Developer** focused on building **scalable, maintainable, and well-architected software systems**.

I enjoy designing applications that are **easy to extend, test, and evolve over time**, applying solid engineering principles and modern development practices.

---

# 🇺🇸 About Me

I'm a **Full Stack Developer** passionate about creating reliable and well-structured software.

My work focuses on designing systems that balance **performance, maintainability, and scalability**.
...
Soy **Desarrollador Full Stack** apasionado por crear software **confiable, escalable y bien estructurado**.

Me gusta diseñar aplicaciones que sean **fáciles de mantener, extender y evolucionar**, aplicando buenas prácticas de ingeniería y arquitectura de software.
